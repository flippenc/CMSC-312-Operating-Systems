...
//		sem_wait(&full_sem); // sem=0: wait. sem>0: go and decrement it
		...
		counting_sem_post(&empty_sem); // post (increment) emptybuffer semaphore
...
int main(int argc, int **argv) 
{
	...
	counting_sem_init(&full_sem, SIZE);
